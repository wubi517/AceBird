package com.kds.gold.acebird.pickerview;
...
public class PickerView extends RelativeLayout {
    ...
    private int itemsToShow = 9, middleCell, cellHeight, firstVisibleItem = 0;
    ...
    public void onWindowFocusChanged(boolean hasWindowFocus) {
        ...
        if (!setListView && adapter != null) {
            ...
            listView.setSelection(itemsToShow/2);
            firstVisibleItem = itemsToShow/2;
    ...
    private class PickerListAdapter extends ArrayAdapter<String> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (holder != null) {
                ...
                if (holder.text.getLayoutParams() instanceof MarginLayoutParams) {
                    MarginLayoutParams p = (MarginLayoutParams) holder.text.getLayoutParams();
                    p.height = cellHeight;
