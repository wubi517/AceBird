...
public class SeriesIjkPlayerActivity extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener, TracksFragment.ITrackHolder,
    ...
    Runnable mTicker;
    String cont_url;
    int dration_time = 0,episode_num;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        portal = (String) MyApp.instance.getPreference().get(Constants.APP_DOMAIN);
    ...
    private void getUrl(){
        GetDataService dataService = new GetDataService(SeriesIjkPlayerActivity.this);
        dataService.getData(SeriesIjkPlayerActivity.this,portal+"portal.php?type=vod&action=create_link&cmd="+cmd+"&series="+episode_num+"&forced_storage=&disable_ad=0&download=0&force_ch_link_check=0&JsHttpRequest=1-xml",100);
        dataService.onGetResultsData(SeriesIjkPlayerActivity.this);
    }
        ...
        if (event.getAction() == KeyEvent.ACTION_DOWN) {
            switch (event.getKeyCode()) {
                ...
                case KeyEvent.KEYCODE_MENU:
                    PackageDlg packageDlg = new PackageDlg(SeriesIjkPlayerActivity.this, pkg_datas, new PackageDlg.DialogPackageListener() {
                        @Override
                        public void OnItemClick(Dialog dialog, int position) {
                            ...
                            switch (position) {
                                ...
                                case 1:
                                    ...
                                    String aspectRatioText = MeasureHelper.getAspectRatioText(SeriesIjkPlayerActivity.this, aspectRatio);
